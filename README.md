...
```
cd existing_repo
git remote add origin https://code.flowable.com/flw-us/flwus-kubernetesplayground/flowable-models-repo.git
git branch -M master
...
- [ ] [Set up project integrations](https://code.flowable.com/flw-us/flwus-kubernetesplayground/flowable-models-repo/-/settings/integrations)
